        ...
        controller.setupWebserver(process.env.PORT,function(err,webserver) {
            ...
            controller.createOauthEndpoints(controller.webserver,function(err,req,res) {
                if (err) {
                    ...
                    res.redirect('http://focusedtalk.tech/installed')
                    // res.send('The bot has been installed to your workspace & sent you a greeting in Slack! If you have any questions maximzavadskiy@gmail.com is always here to listen.');
                }
            });
        });
